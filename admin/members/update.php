...
$stmt->bind_param('sssssssssis', $_POST['full_name'], $_POST['gender'], $_POST['dob'], $_POST['address'], $_POST['aadhaar'], $_POST['mobile'], $_POST['email'], $_POST['joining_date'], $photo, $status, $memberId);
$stmt->execute();
...
if ($exists) {
    ...
    $stmt->bind_param('sssssss', $_POST['acc_no'], $_POST['acc_name'], $_POST['bank_name'], $_POST['ifsc'], $bankDoc, $_POST['upi'], $memberId);
    $stmt->execute();
} else {
    // INSERT (first time)
    $stmt = $conn->prepare("
...
if ($newPass !== '') {
    ...
    $stmt->bind_param("ss", $hash, $memberId);
    $stmt->execute();
}
